...
<div style="max-width:100%">
  <img class="mySlides" src="{{ '/assets/img/produtos/camiseta-eua/camiseta-01.jpeg'
  | prepend: site.baseurl }}" style="width:60%">
  <img class="mySlides" src="{{ '/assets/img/produtos/camiseta-eua/camiseta-02.jpg'
  | prepend: site.baseurl }}" style="width:60%">
  <img class="mySlides" src="{{ '/assets/img/produtos/camiseta-eua/camiseta-03.jpg'
  | prepend: site.baseurl }}" style="width:60%">
  <img class="mySlides" src="{{ '/assets/img/produtos/camiseta-eua/camiseta-04.jpg'
  | prepend: site.baseurl }}" style="width:60%">
  <img class="mySlides" src="{{ '/assets/img/produtos/camiseta-eua/camiseta-05.jpg'
  | prepend: site.baseurl }}" style="width:60%">

  <img class="demo opacity hover-opacity-off img-galeria"
  src="{{ '/assets/img/produtos/camiseta-eua/camiseta-01.jpeg'
  | prepend: site.baseurl }}" onclick="currentDiv(1)"
  alt="Imagem {{ post.title | escape }} 1">
  <img class="demo opacity hover-opacity-off img-galeria"
  src="{{ '/assets/img/produtos/camiseta-eua/camiseta-02.jpg'
  | prepend: site.baseurl }}" onclick="currentDiv(2)"
  alt="Imagem {{ post.title | escape }} 2">
  <img class="demo opacity hover-opacity-off img-galeria"
  src="{{ '/assets/img/produtos/camiseta-eua/camiseta-03.jpg'
  | prepend: site.baseurl }}" onclick="currentDiv(3)"
  alt="Imagem {{ post.title | escape }} 3">
  <img class="demo opacity hover-opacity-off img-galeria"
  src="{{ '/assets/img/produtos/camiseta-eua/camiseta-04.jpg'
  | prepend: site.baseurl }}" onclick="currentDiv(4)"
  alt="Imagem {{ post.title | escape }} 4">
  <img class="demo opacity hover-opacity-off img-galeria"
  src="{{ '/assets/img/produtos/camiseta-eua/camiseta-05.jpg'
  | prepend: site.baseurl }}" onclick="currentDiv(5)"
  alt="Imagem {{ post.title | escape }} 5">
</div>
